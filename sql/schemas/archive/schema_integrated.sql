...
CREATE INDEX idx_conversations_created ON peregrine_alpha.conversations(created_at DESC);

CREATE INDEX idx_turns_conversation ON peregrine_alpha.turns(conversation_id);
