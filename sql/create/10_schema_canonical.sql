...
CREATE SEQUENCE IF NOT EXISTS public.consistency_results_id_seq;
...
CREATE TABLE IF NOT EXISTS public."agent_interaction_decisions" (
...
CREATE TABLE IF NOT EXISTS public."agent_interaction_flow" (
    "id" uuid DEFAULT gen_random_uuid() NOT NULL,
    "product_id" uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."agent_interaction_inputs" (
    "id" uuid DEFAULT gen_random_uuid() NOT NULL,
    "product_id" uuid NOT NULL,
    "agent_interaction_id" uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."agent_interaction_libraries" (
    "id" uuid DEFAULT gen_random_uuid() NOT NULL,
    "product_id" uuid NOT NULL,
    "agent_interaction_id" uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."agent_interaction_metrics" (
    "id" uuid DEFAULT gen_random_uuid() NOT NULL,
    "product_id" uuid NOT NULL,
    "agent_interaction_id" uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."agent_interaction_outputs" (
    "id" uuid DEFAULT gen_random_uuid() NOT NULL,
    "product_id" uuid NOT NULL,
    "agent_interaction_id" uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."peregrine_benchmark_results" (
    "id" text NOT NULL,
    "product_id" uuid,
...
CREATE TABLE IF NOT EXISTS public."peregrine_benchmark_runs" (
    "id" text NOT NULL,
    "product_id" uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."peregrine_consistency_results" (
...
CREATE TABLE IF NOT EXISTS public."auth_tenant_mapping" (
    "id" uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."gold_prompt_metadata_staging" (
    "prompt_text" text NOT NULL,
    "ground_truth_id" text,
    "category" text,
    "subcategory" text,
...
CREATE TABLE IF NOT EXISTS public."jailbreak_attempts" (
    "id" text NOT NULL,
    "conversation_id" text,
    "turn_id" text,
    "product_id" uuid,
...
DO $$ BEGIN
    ALTER TABLE ONLY public."peregrine_benchmark_results" ADD CONSTRAINT "benchmark_results_product_id_fkey" FOREIGN KEY (product_id) REFERENCES products(id) ON DELETE SET NULL;
EXCEPTION
    WHEN duplicate_object THEN NULL;
END $$;
DO $$ BEGIN
    ALTER TABLE ONLY public."peregrine_benchmark_results" ADD CONSTRAINT "benchmark_results_pkey" PRIMARY KEY (id);
EXCEPTION
    WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
    ALTER TABLE ONLY public."peregrine_benchmark_runs" ADD CONSTRAINT "benchmark_runs_pkey" PRIMARY KEY (id);
EXCEPTION
    WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
    ALTER TABLE ONLY public."peregrine_consistency_results" ADD CONSTRAINT "consistency_results_pkey" PRIMARY KEY (id);
EXCEPTION
    WHEN duplicate_object THEN NULL;
END $$;
...
CREATE INDEX IF NOT EXISTS idx_agent_interaction_decisions_interaction ON public.agent_interaction_decisions USING btree (agent_interaction_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_decisions_product ON public.agent_interaction_decisions USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_decisions_type ON public.agent_interaction_decisions USING btree (decision_type);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_flow_generation_run ON public.agent_interaction_flow USING btree (generation_run_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_flow_product ON public.agent_interaction_flow USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_flow_sequence ON public.agent_interaction_flow USING btree (generation_run_id, flow_sequence);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_flow_source ON public.agent_interaction_flow USING btree (source_agent_interaction_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_flow_target ON public.agent_interaction_flow USING btree (target_agent_interaction_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_inputs_interaction ON public.agent_interaction_inputs USING btree (agent_interaction_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_inputs_key ON public.agent_interaction_inputs USING btree (input_key);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_inputs_product ON public.agent_interaction_inputs USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_libraries_created ON public.agent_interaction_libraries USING btree (created_at);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_libraries_interaction ON public.agent_interaction_libraries USING btree (agent_interaction_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_libraries_library_type ON public.agent_interaction_libraries USING btree (library_type);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_libraries_product ON public.agent_interaction_libraries USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_metrics_category ON public.agent_interaction_metrics USING btree (metric_category);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_metrics_interaction ON public.agent_interaction_metrics USING btree (agent_interaction_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_metrics_name ON public.agent_interaction_metrics USING btree (metric_name);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_metrics_product ON public.agent_interaction_metrics USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_outputs_interaction ON public.agent_interaction_outputs USING btree (agent_interaction_id);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_outputs_key ON public.agent_interaction_outputs USING btree (output_key);
CREATE INDEX IF NOT EXISTS idx_agent_interaction_outputs_product ON public.agent_interaction_outputs USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_agent_interactions_ai_agent ON public.agent_interactions USING btree (ai_agent_id);
CREATE INDEX IF NOT EXISTS idx_agent_interactions_created ON public.agent_interactions USING btree (created_at);
CREATE INDEX IF NOT EXISTS idx_agent_interactions_generation_run ON public.agent_interactions USING btree (generation_run_id);
CREATE INDEX IF NOT EXISTS idx_agent_interactions_product ON public.agent_interactions USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_agent_interactions_sequence ON public.agent_interactions USING btree (generation_run_id, interaction_sequence);
CREATE INDEX IF NOT EXISTS idx_agent_interactions_status ON public.agent_interactions USING btree (status);
CREATE INDEX IF NOT EXISTS idx_agent_interactions_tenant ON public.agent_interactions USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_peregrine_benchmark_results_active ON public.peregrine_benchmark_results USING btree (id) WHERE (archived = false);
CREATE INDEX IF NOT EXISTS idx_benchmark_ground_truth_id ON public.peregrine_benchmark_results USING btree (ground_truth_id);
CREATE INDEX IF NOT EXISTS idx_benchmark_product_id ON public.peregrine_benchmark_results USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_benchmark_results_benchmark ON public.peregrine_benchmark_results USING btree (benchmark_name);
CREATE INDEX IF NOT EXISTS idx_benchmark_results_category ON public.peregrine_benchmark_results USING btree (category);
CREATE INDEX IF NOT EXISTS idx_benchmark_results_created ON public.peregrine_benchmark_results USING btree (created_at DESC);
CREATE INDEX IF NOT EXISTS idx_benchmark_results_expected_behavior ON public.peregrine_benchmark_results USING btree (expected_behavior);
CREATE INDEX IF NOT EXISTS idx_benchmark_results_ground_truth_id ON public.peregrine_benchmark_results USING btree (ground_truth_id);
CREATE INDEX IF NOT EXISTS idx_benchmark_results_model ON public.peregrine_benchmark_results USING btree (model_id);
CREATE INDEX IF NOT EXISTS idx_benchmark_results_product ON public.peregrine_benchmark_results USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_benchmark_results_run_id ON public.peregrine_benchmark_results USING btree (benchmark_run_id);
CREATE INDEX IF NOT EXISTS idx_peregrine_benchmark_runs_active ON public.peregrine_benchmark_runs USING btree (id) WHERE (archived = false);
CREATE INDEX IF NOT EXISTS idx_peregrine_benchmark_runs_tenant ON public.peregrine_benchmark_runs USING btree (tenant_id);
CREATE INDEX IF NOT EXISTS idx_benchmark_runs_created ON public.peregrine_benchmark_runs USING btree (created_at DESC);
CREATE INDEX IF NOT EXISTS idx_benchmark_runs_model ON public.peregrine_benchmark_runs USING btree (model_key);
CREATE INDEX IF NOT EXISTS idx_benchmark_runs_peregrine ON public.peregrine_benchmark_runs USING btree (peregrine_score_n DESC);
CREATE INDEX IF NOT EXISTS idx_benchmark_runs_phi ON public.peregrine_benchmark_runs USING btree (phi_score_phi);
CREATE INDEX IF NOT EXISTS idx_benchmark_runs_product ON public.peregrine_benchmark_runs USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_benchmark_runs_prompt_count ON public.peregrine_benchmark_runs USING btree (prompt_responses_count);
CREATE INDEX IF NOT EXISTS idx_peregrine_consistency_results_active ON public.peregrine_consistency_results USING btree (id) WHERE (archived = false);
CREATE INDEX IF NOT EXISTS idx_consistency_created ON public.peregrine_consistency_results USING btree (created_at DESC);
CREATE INDEX IF NOT EXISTS idx_consistency_gen_run ON public.peregrine_consistency_results USING btree (generation_run_id);
CREATE INDEX IF NOT EXISTS idx_consistency_model ON public.peregrine_consistency_results USING btree (model_key);
CREATE INDEX IF NOT EXISTS idx_consistency_product ON public.peregrine_consistency_results USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_consistency_sigma ON public.peregrine_consistency_results USING btree (stability_score_sigma);
CREATE INDEX IF NOT EXISTS idx_consistency_source ON public.peregrine_consistency_results USING btree (source);
...
CREATE INDEX IF NOT EXISTS idx_analysis_ground_truth_id ON public.analysis_results USING btree (ground_truth_id);
CREATE INDEX IF NOT EXISTS idx_analysis_product_id ON public.analysis_results USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_auth_tenant_mapping_auth_user ON public.auth_tenant_mapping USING btree (auth_user_id) WHERE (is_active = true);
...
CREATE INDEX IF NOT EXISTS idx_conversation_embeddings_conversation_id ON public.conversation_embeddings USING btree (conversation_id);
CREATE INDEX IF NOT EXISTS idx_conversation_embeddings_product_id ON public.conversation_embeddings USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_conversation_metrics_conversation_id ON public.conversation_metrics USING btree (conversation_id);
CREATE INDEX IF NOT EXISTS idx_conversation_metrics_ground_truth_id ON public.conversation_metrics USING btree (ground_truth_id);
CREATE INDEX IF NOT EXISTS idx_conversation_metrics_product_id ON public.conversation_metrics USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_harms_product ON public.harms USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_jailbreak_conversation_id ON public.jailbreak_attempts USING btree (conversation_id);
CREATE INDEX IF NOT EXISTS idx_jailbreak_ground_truth_id ON public.jailbreak_attempts USING btree (ground_truth_id);
CREATE INDEX IF NOT EXISTS idx_jailbreak_product_id ON public.jailbreak_attempts USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_jailbreak_turn_id ON public.jailbreak_attempts USING btree (turn_id);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_agent ON public.llm_invocations USING btree (agent_id);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_agent_stage ON public.llm_invocations USING btree (agent_id, pipeline_stage);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_conversation ON public.llm_invocations USING btree (conversation_id);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_created ON public.llm_invocations USING btree (created_at);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_model ON public.llm_invocations USING btree (model_name);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_product ON public.llm_invocations USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_product_created ON public.llm_invocations USING btree (product_id, created_at);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_scenario ON public.llm_invocations USING btree (scenario_id);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_session ON public.llm_invocations USING btree (session_id);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_session_status ON public.llm_invocations USING btree (session_id, status);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_stage ON public.llm_invocations USING btree (pipeline_stage);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_status ON public.llm_invocations USING btree (status);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_trace ON public.llm_invocations USING btree (trace_id);
CREATE INDEX IF NOT EXISTS idx_llm_invocations_turn ON public.llm_invocations USING btree (turn_id);
CREATE INDEX IF NOT EXISTS idx_model_metadata_product_id ON public.model_metadata USING btree (product_id);
...
CREATE INDEX IF NOT EXISTS idx_safety_conversation_id ON public.safety_scores USING btree (conversation_id);
CREATE INDEX IF NOT EXISTS idx_safety_ground_truth_id ON public.safety_scores USING btree (ground_truth_id);
CREATE INDEX IF NOT EXISTS idx_safety_product_id ON public.safety_scores USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_safety_turn_id ON public.safety_scores USING btree (turn_id);
...
CREATE INDEX IF NOT EXISTS idx_turn_embeddings_product_id ON public.turn_embeddings USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_turn_embeddings_turn_id ON public.turn_embeddings USING btree (turn_id);
